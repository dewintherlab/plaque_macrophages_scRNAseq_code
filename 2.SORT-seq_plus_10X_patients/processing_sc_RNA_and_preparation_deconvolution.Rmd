...
```{r}
bulkToMatch <- read_rds("data/preprocessed_data/bACSccfRNA.rds") # MODIFY HERE
...
```{r}
patternBulk <- "rTS_bACSccfRNA" # MODIFY HERE
patternRef <- "rTS_bACSccfRNA_c17_v1" # MODIFY HERE
